...
import 'package:creative_datetime_picker/src/components/custom_tab_bar.dart';
import 'package:creative_datetime_picker/src/components/time_picker_spinner.dart';

class CreativeDtpRange extends StatefulWidget {
  const CreativeDtpRange({
    super.key,
  ...
  @override
  State<CreativeDtpRange> createState() => _CreativeDtpRangeState();
}

class _CreativeDtpRangeState extends State<CreativeDtpRange>
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          if (widget.type == CreativeDateTimePickerType.dateAndTime)
            Padding(
